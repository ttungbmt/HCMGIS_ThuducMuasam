(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tree-model'), require('performant-array-to-tree'), require('flattree'), require('nanoid'), require('lodash-es')) :
  typeof define === 'function' && define.amd ? define(['exports', 'tree-model', 'performant-array-to-tree', 'flattree', 'nanoid', 'lodash-es'], factory) :
  (global = global || self, factory(global.TreeJS = {}, global.treeModel, global.performantArrayToTree, global.flattree, global.nanoid, global.lodashEs));
}(this, (function (exports, treeModel, performantArrayToTree, flattree, nanoid, lodashEs) {
