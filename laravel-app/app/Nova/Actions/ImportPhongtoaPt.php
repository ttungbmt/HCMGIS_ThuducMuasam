...
class ImportPhongtoaPt extends Action
{
    ...
    {
        $sampleUrl = Storage::url('imports/phongtoa_pt.xlsx');

        return [
            File::make('File')->rules('required')->help('Tải file mẫu: <a class="no-underline" href="' . $sampleUrl . '" target="_blank">phongtoa_pt.xlsx</a>'),
