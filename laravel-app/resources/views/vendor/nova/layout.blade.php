<?php
//dd(\Larabase\Nova\Support\MenuHelper::getSidebarTools());
...
<head>
    ...
    @setting('appearance.html_scripts_header')
</head>
<body class="min-w-site bg-40 text-90 font-medium min-h-full">
        ...
        <div v-cloak class="flex min-h-screen">
            ...
            <div class="content">
                <div class="flex items-center relative shadow h-header bg-white z-20 px-view">
                    ...
                    <dropdown class="h-9 flex items-center dropdown-right pl-4">
    ...
    @setting('appearance.html_scripts_footer')
</body>
</html>
